import {
 ...
 export const obterUsuario = async (req, res) => {
   ...
   try {
     const user = await obterUsuarioPorId(parseInt(id)); // Converte o ID para número
 ...
 export const atualizarUsuarioController = async (req, res) => {
   const { userId } = req.params; // Pega o ID da requisição
   const data = req.body;
 
   try {
     const usuarioAtualizado = await atualizarUsuario(parseInt(userId), data); // Converte o userId para número
 ...
 export const deletarUsuarioController = async (req, res) => {
   ...
   try {
     await deletarUsuario(parseInt(userId)); // Converte o userId para número
