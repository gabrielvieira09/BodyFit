import "../styles/preTreino.css"
import Header from "../components/Header";
import Footer from "../components/Footer";
import banner from "../assets/banners/banner(preTreino).png";
...
export default function PreTreino() {
      ...
      const fetchData = async () => {
         try {
            ...
            const produtosFiltrados = produtosResponse.data.filter((produto) =>
               produto.nome.toLowerCase().includes("pré") // Verifica o nome
            );
  ...
  return (
    <div className="preTreino_container">
      <Header />
