import "../styles/wheyProtein.css"
import Header from "../components/Header";
import Footer from "../components/Footer";
import banner from "../assets/banners/banner(whey).png"
...
export default function WheyProtein() {
      ...
      const fetchData = async () => {
         try {
            ...
            const produtosFiltrados = produtosResponse.data.filter((produto) =>
               produto.nome.toLowerCase().includes("whey") // Verifica o nome
            );
   ...
   return (
      <div className="wheyProtein_container">
         <Header />
